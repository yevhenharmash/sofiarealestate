...
const dictionaries: Record<Lang, Dictionary> = {
  bg: {
    ...
    'listing.sourceImotbg': 'От imot.bg',
    'listing.approximateLocation': 'Приблизителна локация',

    'detail.back': 'Обратно към {count} обяви',
    'detail.photoIndex': '{current} / {total}',
    'detail.postedBy': 'Публикувано от собственик',
    'detail.sourceImotbg': 'Обява от imot.bg',
    'detail.approximateLocation': 'Приблизителна локация',
  ...
  en: {
    ...
    'listing.sourceImotbg': 'From imot.bg',
    'listing.approximateLocation': 'Approximate location',

    'detail.back': 'Back to {count} listings',
    'detail.photoIndex': '{current} / {total}',
    'detail.postedBy': 'Posted by owner',
    'detail.sourceImotbg': 'Listing from imot.bg',
    'detail.approximateLocation': 'Approximate location',
